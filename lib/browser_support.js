...
exports.DECLARATIONS_REMOVED = {
    ...
    'box-align': {ie: 0, chrome: 0, firefox: 0}, // Nobody ever implemented an un-prefixed box declarations (now obsolete).
    'box-flex': {ie: 0, chrome: 0, firefox: 0},
    'box-ordinal-group': {ie: 0, chrome: 0, firefox: 0},
    'box-orient': {ie: 0, chrome: 0, firefox: 0},
    'box-pack': {ie: 0, chrome: 0, firefox: 0},
    '-moz-flex': {firefox: 0},  // Some new flexbox declarations were never prefixed in Gecko.
};
