...
export {default as PseudoElementSelector} from './nodes/PseudoElementSelector';
export {
...
export {default as SupportsConditionList} from './nodes/SupportsConditionList';
...
export function createSupportsConditionList(
  ...
  if (base instanceof SupportsConditionList && base.combinator === combinator) {
    ...
    return new SupportsConditionList(combinator, [addition, base]);
  }
}
